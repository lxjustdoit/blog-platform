...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('You account has been successfully updated','success')
...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('home'))
    return render_template('create_post.html',title='New Blog', form=form, legend='New Post')
...
def update_post(post_id):  
    ...
    return render_template('create_post.html',title='Blog Update', form=form, legend='Update Post')
